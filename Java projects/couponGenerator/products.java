...
public class products {
    ...
    public void HomeAppliances(){
        System.out.println("You have Choosed HomeAppliances");
    ...
    public void ComputerAccessories(){
        System.out.println("You have Choosed ComputerAccessories");
        System.out.println("1. HP Laptop = Rs. 450000/-");
        System.out.println("2. Acer VeritonPC Price = Rs.27000/-");
        System.out.println("3. Dell Inspiron Price = Rs.62500/-");
    }
    public void watches(){
        System.out.println("You have Choosed watches");
    ...
    public void Bikes(){
        System.out.println("You have Choosed Bikes");
